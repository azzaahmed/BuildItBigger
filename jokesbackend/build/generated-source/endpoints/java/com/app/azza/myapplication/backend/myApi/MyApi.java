 ...
 * on 2017-04-17 at 21:39:00 UTC 
 * Modify at your own risk.
 */

package com.app.azza.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://tawsela-146913.appspot.com/_ah/api/";
  ...
  public class GetJoke extends MyApiRequest<com.app.azza.myapplication.backend.myApi.model.MyBean> {
     ...
     */
    protected GetJoke() {
      super(MyApi.this, "GET", REST_PATH, null, com.app.azza.myapplication.backend.myApi.model.MyBean.class);
    }
  ...
  public class SayHi extends MyApiRequest<com.app.azza.myapplication.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.app.azza.myapplication.backend.myApi.model.MyBean.class);
